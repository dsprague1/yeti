...
if (Meteor.isServer) {                                                         // 5
  ...
  Template.serverFacts.created = function () {                                 // 87
    this._stopHandle = Meteor.subscribe("meteor_facts");                       // 88
  };                                                                           // 89
  Template.serverFacts.destroyed = function () {                               // 90
